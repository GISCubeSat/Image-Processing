...
def determine_img_to_seg():
    folder_path = "ORIGINAL_IMAGES/BlueEarthTest.jpeg"
    
    directory_list = os.listdir(folder_path)

    visual_index_sum = 0
    best_img = "/Users/Arush/Documents/GitHub/Image-Processing/ORIGINAL_IMAGES/BlueEarthTest.jpeg"
    ...
    best_img.save(f"{best_img}.webp", 'webp', optimize = True, quality = 10)
...
def segmented_image(input_path, output_folder, segment_size = (160, 120)):
    ...
    for i in range(0, img_width, segment_size[0]):
        for j in range(0, img_height, segment_size[1]):
            ...
            # Compression and Saving Files
            segment.save(output_path)

    print("Segmentation complete!")
ak_path = "/Users/Arush/Documents/GitHub/Image-Processing/"
compress("/Users/Arush/Documents/GitHub/Image-Processing/ORIGINAL_IMAGES", 'BlueEarthTest.jpeg', 20, 50)
...
segmented_image("/Users/Arush/Documents/GitHub/Image-Processing/CMP_IMAGES/CMPBlueEarthTest.jpeg", output_folder)
